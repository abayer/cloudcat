...
<html>
	...
	<body>
		<a href="#edit-provisionedInstanceGroup" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-provisionedInstanceGroup" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${provisionedInstanceGroupInstance?.version}" />
				<fieldset class="form">
